...
def main(page: ft.Page):
    ...
    def favorite_icon(icon_name: str):
        ...
        show_search_page()  # Atualiza a grade ao favoritar
        ...
        for icon_name in dir(ft.Icons):
            if search_value in icon_name:
                icons_grid.controls.append(create_icon_container(
                    icon_name=icon_name,
                    on_favorite=favorite_icon,
                    is_favorite=icon_name in favorites
                ))
        icons_grid.update()
...
# Adiciona a lista de favoritos ao escopo da função para referência dentro de icon_container
