...
l_linha = Label(
    frameCima, width=295, height=1, anchor=NW, font=("Verdana 1"), bg=co3, fg=co1
)
l_linha.place(x=0, y=47)

# Frame Meio
l_valor_quantia = Label(
    frameMeio,
    text="Renda Mensal?",
    height=1,
    anchor=NW,
...
e_valor_quantia = Entry(
    frameMeio, width=10, font=("Ivy 14"), justify="center", relief="solid"
)
...
l_necessidades = Label(
    frameBaixo, width=22, height=1, anchor=NW, font=("Verdana 10"), bg=co1, fg=co4
)
l_necessidades.place(x=10, y=75)

l_total_desejos = Label(
    frameBaixo, text="Desejos", height=1, anchor=E, font=("Verdana 10"), bg=co9, fg=co0
)
l_total_desejos.place(x=10, y=115)

l_desejos = Label(
    frameBaixo, width=22, height=1, anchor=NW, font=("Verdana 12"), bg=co1, fg=co4
)
l_desejos.place(x=10, y=145)

l_total_poupanca = Label(
    frameBaixo, text="Poupança", height=1, anchor=E, font=("Verdana 10"), bg=co9, fg=co0
)
